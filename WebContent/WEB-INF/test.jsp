...
<head>
	...
	div.backgroundImg{
		background: url("./images/backMind.png") no-repeat;
		border: none;
		position: relative;
		left:100px;
    ...
    window.open('./create.html','popup', 'width=500, height=400,left=500,top=200,toolbar=no, location=no, directories=no, status=no, menubar=no, resizable=no, scrollbars=no, copyhistory=no'); 
 	}
			...
			<tr>
            	...
            	<td align="center">
            		<form method="post" action="#">
            			<input class="session_button" type="button" onclick="javascript:open_session();"/>
             		</form>
